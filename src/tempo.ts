 ...
 */
export function join(a: TempoLike, b: TempoLike): Tempo {
  if (a.zero !== b.zero) {
 ...
 */
export class Tempo<Base extends TempoBase = TempoBase> implements TempoLike {
  constructor(
  ...
  reset(now: number = Date.now()): Tempo<Base> {
   ...
   */
  static async sleep(tempos: Tempo<any>[]) {
