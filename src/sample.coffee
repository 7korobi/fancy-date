...
月 = [        2551442889.6, 1577310360000] # 2019/12/26 06:46
ガニメデ = [     618192000, 0 ]
カリスト = [    1441929600, 0 ]
タイタン = [    1377684374.4, 0 ]
チタニア = [     752198400, 0 ]
...
地球 = [
  [31556925147.0, 1553119080000] # 2019/03/21 06:58
  月
...
火星 = [
  [59355616881.6, 1540684800000] # 公転周期 UTC 2018/10/28 00:00
  null
  [   88740035.244 , 0, 25.19] # 自転周期 24時間39分35秒。
  [ 35, 0 ]
]
...
金星 = [
  [19414456423.2, 1553119080000] # 公転周期 2019/03/21 06:58
  null
...
FancyDate.Romulus = g = new FancyDate()
  .planet   ...地球
  .era "ロムルス暦"
  .calendar(
    ["1970年(A)",'y年(E)', 0]
...
FancyDate.MarsGregorian = FancyDate.Gregorian.dup()
  ...
  .era "西暦"
  .calendar(
    ["1年(木) 庚戌-辛巳",'y年(E) a-A', g.parse "0年4月1日"] # 春分が３月くらいになるよう、恣意的に決めました。
    [1, 7, 70]
  )
  .init()
