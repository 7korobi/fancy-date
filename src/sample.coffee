...
[11,13,15,17,19,21,24,0,2,4,7,9]
二十八宿 = ['角','亢','氐','房','心','尾','箕'   # 東方青龍
          '斗','牛','女','虚','危','室','壁'   # 北方玄武
          '奎','婁','胃','昴','畢','觜','参'   # 西方百虎
          '井','鬼','柳','星','張','翼','軫' ] # 南方朱雀
二十七宿 = 二十八宿.filter (s)=> '牛' != s

九星かな = ["きゅうしか","はっぱくど","しちせききん","ろっぱくきん","ごおうど","しろくもく","さんぺきもく","じこくど","いっぱくすい"]
九曜かな = ["らごう","どよう","すいよう","きんよう","にちよう","かよう","けいと","げつよう","もくよう"]
七曜かな = ["げつ","か","すい","もく","きん","ど","にち"]
六曜かな = ["せんかち","ともびき","せんまけ","ぶつめつ","たいあん","しゃっく"]

二十八宿かな = ['す','あみ','とも','そい','なかご','あしたれ','み'   # 東方青龍
   'ひきつ','いなみ','うるき','とみて','うみやめ','はつい','なまめ'   # 北方玄武
  'とかき','たたら','えきえ','すばる','あめふり','とろき','からすき'   # 西方百虎
'ちちり','たまほめ','ぬりこ','ほとおり','ちりこ','たすき','みつかけ' ] # 南方朱雀
二十七宿かな = 二十八宿.filter (s)=> 'いなみ' != s
...
FancyDate.平気法 = g.dup()
  ...
  .era "皇紀", "紀元前", 北朝元号
  .calendar(
    ["2629年12月7日 赤口-昴 己酉-辛巳 九紫火-七赤金",'y年M月d日 E-V a-A f-F', 0]
  )
  .daily "Sunny"
  .algo(
    E: [六曜,六曜かな]
