...
exports.angle = exports.roman = exports.english = exports.old_jpn = exports.jpn = exports.DIC = void 0;
exports.mod = mod;
...
exports.old_jpn = {
    rubys: new DIC([12, 2, 2, 2, 2, 0.1], 'まり', '', 'だーす つい つがい そく そう わり', 'れい ひと ふた み よ いつ む なな や ここの', 'せいじょう こくう りっとく せつな だんし しゅんそく しゅゆ しゅんじゅん もこ ばく びょう あい じん しゃ せん び こつ し もう りん ぶ ひと そ ほ ち', 'よろづ おく ちょう けい がい じょ じょう こう かん せい さい ごく ごうがしゃ あそうぎ なゆた ふかしぎ むりょうたいすう').音便((num, str, tail = 'つ') => {
        if (!str)
            return '';
        if (num < 1)
            return str;
...
exports.english = {
    ...
    title: { parse: (num) => englishize(num).replace(/\b\w/g, (char) => char.toUpperCase()), regex: '[A-Za-z]+(?:[- ][A-Za-z]+)*', to_number: english_to_number },
};
exports.roman = {
    upper: { parse: romanize, regex: '[IVXLCDM]+', to_number: roman_to_number },
    lower: { parse: (num) => romanize(num).toLowerCase(), regex: '[ivxlcdm]+', to_number: roman_to_number },
};
