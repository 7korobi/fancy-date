...
export { bodyProfileOf, centerOf, hasLunarEvents, hasLunarOrbitEvents, hasSolarEvents, isPlanetSkyBody, orbitalOf, placePlanet, placeSatellite, placeStar, resolveSkyBody, rotationOf, } from './orbital-model';
export type { BodyProfile, BodyProfileReference, STAR, PLANET_TUPLE, SATELLITE_TUPLE, PlanetPlacement, SatellitePlacement, PLANET, SATELLITE, SKY_BODY, SPOT, TIMEZONE, ORBITAL, ROTATION, PlanetPlacementOptions, SatellitePlacementOptions, OrbitalModel, OrbitalTransformOptions, RotationModel, ResolvedSkyBody, SolarObservationOptions, SolarObservation, SolarEquatorialCoordinates, SolarHorizontalCoordinates, SolarPositionModel, SolarEventModel, LunarObservationOptions, LunarObservation, LunarEquatorialCoordinates, LunarHorizontalCoordinates, LunarPositionModel, LunarEventModel, LunarApsisKind, LunarApsis, LunarNodeKind, LunarNode, LunarOrbitEventModel, } from './orbital-model';
...
declare const cycle_tokens: readonly ["yC60", "yC12", "yC10", "yC9", "dC60", "dC12", "dC10", "dC9", "dC7", "dC8", "dC28", "R6", "LM27"];
type CycleToken = (typeof cycle_tokens)[number];
declare const legacy_token_aliases: {
    readonly yC: "yC60";
    readonly yCS: "yC10";
    readonly yCB: "yC12";
    readonly dC: "dC60";
...
export declare class FancyDate {
    ...
    format_parts(utc: DateLike, str?: string): FormatPart[];
    ...
    * d/N(dayStart() による太陽イベント起点の暦日)で使う SolarEventDayTempoRule を
    ...
    private seasonal_note_labels;
    private date_note_labels;
    ...
    * parent を誤って使い回す実バグが
     ...
     */
    private resolve_day_start;
    private half_label;
    private paksha_label;
    format_parts_by(utc: DateLike, str?: string): FormatPart[];
