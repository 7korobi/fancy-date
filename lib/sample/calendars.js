...
const commonNotation = {
    ...
    dC7: [locale_1.七曜, locale_1.七曜かな],
    dC28: [locale_1.二十八宿, locale_1.二十八宿かな],
    Z: [locale_1.二十四節季, locale_1.二十四節季かな],
    yC60: [60],
    dC60: [60],
    dC12: [locale_1.十二支, locale_1.十二支かな],
    dC10: [locale_1.十干, locale_1.十干かな],
};
function baseCalendar() {
    return new fancy_date_1.FancyDate().notation(commonNotation);
}
const romanTemporalNotation = {
    H: [locale_1.ローマ時法時, locale_1.ローマ時法時かな, ' hora'],
    m: [locale_1.ローマ時法分, null, ' pars minuta'],
};
function gregorianBase() {
    return baseCalendar()
        .era('西暦', '紀元前')
        .calendar(['1970年 木-斗 庚戌-辛巳', 'y年 dC7-dC28 yC60-dC60', 0], [4, 100, 400], [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]);
}
const g = fancy_date_1.FancyDate.lazy(() => gregorianBase()
    .spot(...astro_1.London)
    .init());
const UTC = g;
const Gregorian = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(g).spot(...astro_1.東京).init());
const GregorianAstronomical = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(g).spot(...astro_1.天文東京).init());
/**
 ...
 */
const LocalGregorian = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(Gregorian).spot(astro_1.月, 0, 0, (0, time_1.localTimezoneDeg)()).init());
const Julian = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .lang('y年M月d日', 'Gy年M月d日(dC7) Ho mo')
    .spot(...astro_1.Romus)
    .era('西暦', '紀元前')
    .calendar(['1582/10/5(金) 壬午-甲戌', 'y/M/d(dC7) yC60-dC60', g.parse('1582年10月15日')], [4], [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31])
    ...
    .init());
const アマンタ = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .spot(...astro_1.Madurai)
    .era('サカ歴', '紀元前')
    .calendar(['1891-09-08(木) 庚戌-辛巳 三碧木-七赤金', 'y-M-d(dC7) yC60-dC60 yC9-dC9', 0])
    .division({ H: 'solar' })
    .notation({
    yC9: [locale_1.九星, locale_1.九星かな],
    dC9: [locale_1.九星rev, locale_1.九星かなrev],
})
    .init());
const プールニマンタ = fancy_date_1.FancyDate.lazy(() => baseCalendar()
...
const 天文黒分月 = [
    astro_1.天文月[0],
    (0, fancy_date_1.transformOrbital)(astro_1.天文月[1], { phaseOffset: 0.5 }),
    astro_1.天文月[2],
];
const アマンタティティ = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(アマンタ)
    .spot(astro_1.天文月, astro_1.Madurai[1], astro_1.Madurai[2], astro_1.Madurai[3])
    .dayStart('sunrise')
    .assign({ d: (0, fancy_date_1.tithi)() })
    .init());
const プールニマンタティティ = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(プールニマンタ)
    .spot(天文黒分月, astro_1.Jaypore[1], astro_1.Jaypore[2], astro_1.Jaypore[3])
    .dayStart('sunrise')
    .assign({ d: (0, fancy_date_1.tithi)() })
    .init());
...
const 和暦日付ふりがな = Array.from({ length: 30 }, (_, i) => number_1.old_jpn.rubys.語尾('か').parse(i + 1));
const 平気法 = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    ...
    .notation({
    R6: [locale_1.六曜, locale_1.六曜かな],
    LM27: [locale_1.二十七宿, locale_1.二十七宿かな],
    ...
    .init());
const 定気法 = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .lang('Gy年Mod日', 'Gy年Mod日(R6)Homo')
    .spot(...astro_1.天文東京)
    .era('皇紀', '紀元前', eras_1.北朝元号)
    ...
    .init());
const Romulus = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    ...
    .spot(...astro_1.Romus)
    .era('ロムルス暦', '紀元前')
    .calendar(['754年1月16日(H) 辛酉-己亥', 'y年M月d日(dC8) yC60-dC60', g.parse('1年3月22日')], null, [31, 30, 31, 30, 31, 30, 30, 31, 30, 30, null])
    .notation({
...
// で表現)。
const バビロニア暦カスプ = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    ...
    .init());
const バビロニア暦ベール = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(バビロニア暦カスプ)
    .division({ H: false })
    .dayStart('midnight')
    .dayBoundary(18)
    .notation({
...
const オスマン季節時法 = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(Julian)
...
// (dayBoundary(18))。
const アラトゥルカ = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(オスマン季節時法)
    .division({ H: false })
    .dayStart('midnight')
    .dayBoundary(18)
    .init());
// Gregorianは太陽暦なので、衛星未定義でもよい
const MarsGregorian = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .spot(astro_1.火星, 35, 0, 0)
    .era('西暦', '紀元前')
    .calendar(['1年(火) 壬子-辛巳', 'y年(dC7) yC60-dC60', g.parse('0年4月1日')], // 春分が３月くらいになるよう、恣意的に決めました。
[1, 7, 70])
    .notation({
    M: [20],
})
    .init());
const Jupiter = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .spot(astro_1.カリスト, 35, 0, 0)
    .era('西暦', '紀元前')
    .calendar(['1年(火) 壬子-辛巳', 'y年(dC7) yC60-dC60', g.parse('0年4月1日')])
    .notation({
    H: [10],
    M: [260],
    N: [40],
    ...
    .init());
const フランス革命暦 = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .spot(...astro_1.Paris)
    .era('革命暦', '紀元前')
    .calendar(['1年1月1日 1曜 壬子-癸酉', 'y年M月d日 dC10曜 yC60-dC60', g.parse('1792年9月22日')], [4, 100, 400], [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, null])
    .notation({
    M: [
        [
            '葡萄月',
...
const Maya = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .lang('Gy年Mod日', 'Mo do')
    .spot(マヤ暦地球, 0, 0, 0)
    .era('', '')
...
const Beat = fancy_date_1.FancyDate.lazy(() => gregorianBase()
    .spot(...astro_1.zürich)
    .era('@', '紀元前')
    .notation({
    H: [1000],
...
const エジプト民用暦 = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .spot(エジプト民用暦地球, astro_1.Cairo[1], astro_1.Cairo[2], astro_1.Cairo[3])
    .era('ナボナサル紀元', '紀元前')
    .calendar(['1年トート1日', 'y年Mod日', ナボナサル紀元()], [], [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, null])
    .notation({
    M: [locale_1.エジプト月名, null],
})
    .init());
const コプト暦 = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    .spot(...astro_1.Alexandria)
    .era('コプト暦', '紀元前')
    .calendar(['1736年トウト1日', 'y年Mod日', g.parse('2019年9月11日')], [4], [30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, null], 3)
    .notation({
 ...
 */
const RomanClock = fancy_date_1.FancyDate.lazy(() => new fancy_date_1.FancyDate(Gregorian).numeral(number_1.roman.upper).init());
exports.Calendar = {
    UTC,
    Gregorian,
