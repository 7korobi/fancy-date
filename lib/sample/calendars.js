...
const g = fancy_date_1.FancyDate.lazy(() => gregorianBase()
    ...
    .init());
const UTC = g;
const Gregorian = fancy_date_1.FancyDate.lazy(() => g
    .dup()
    .spot(...astro_1.東京)
    .init());
const GregorianAstronomical = fancy_date_1.FancyDate.lazy(() => g
    .dup()
    .spot(...astro_1.天文東京)
    .init());
/**
 ...
 */
const LocalGregorian = fancy_date_1.FancyDate.lazy(() => Gregorian.dup().spot(astro_1.月, 0, 0, (0, time_1.localTimezoneDeg)()).init());
...
const アマンタティティ = fancy_date_1.FancyDate.lazy(() => アマンタ
    .dup()
    .spot(astro_1.天文月, astro_1.Madurai[1], astro_1.Madurai[2], astro_1.Madurai[3])
    .dayStart('sunrise')
    .assign({ d: (0, fancy_date_1.tithi)() })
    .init());
const プールニマンタティティ = fancy_date_1.FancyDate.lazy(() => プールニマンタ
    .dup()
...
const バビロニア暦カスプ = fancy_date_1.FancyDate.lazy(() => baseCalendar()
    ...
    .init());
const バビロニア暦ベール = fancy_date_1.FancyDate.lazy(() => バビロニア暦カスプ
    .dup()
    .division({ H: false })
    .dayStart('midnight')
    .dayBoundary(18)
...
const オスマン季節時法 = fancy_date_1.FancyDate.lazy(() => Julian.dup()
...
// (dayBoundary(18))。
const アラトゥルカ = fancy_date_1.FancyDate.lazy(() => オスマン季節時法.dup().division({ H: false }).dayStart('midnight').dayBoundary(18).init());
 ...
 */
const RomanClock = fancy_date_1.FancyDate.lazy(() => Gregorian.dup().numeral(number_1.roman.upper).init());
exports.Calendar = {
    UTC,
    Gregorian,
