...
const アマンタティティ = fancy_date_1.FancyDate.lazy(() => アマンタ.dup().dayStart('sunrise').assign({ d: (0, fancy_date_1.tithi)() }).init());
const プールニマンタティティ = fancy_date_1.FancyDate.lazy(() => プールニマンタ.dup().dayStart('sunrise').assign({ d: (0, fancy_date_1.tithi)() }).init());
