...
class EarthMoonOrbital {
    ...
    lunarEquatorial(utc) {
        ...
        const T3 = T2 * T;
        const T4 = T3 * T;
        const Lp = (0, number_1.mod)(218.3164477 + 481267.88123421 * T - 0.0015786 * T2 + T3 / 538841 - T4 / 65194000, 360);
        const D = (0, number_1.mod)(297.8501921 + 445267.1114034 * T - 0.0018819 * T2 + T3 / 545868 - T4 / 113065000, 360);
        const M = (0, number_1.mod)(357.5291092 + 35999.0502909 * T - 0.0001536 * T2 + T3 / 24490000, 360);
        const Mp = (0, number_1.mod)(134.9633964 + 477198.8675055 * T + 0.0087414 * T2 + T3 / 69699 - T4 / 14712000, 360);
        const F = (0, number_1.mod)(93.272095 + 483202.0175233 * T - 0.0036539 * T2 - T3 / 3526000 + T4 / 863310000, 360);
        ...
        sigmaL += 3958 * (0, astro_math_1.sin_deg)(A1) + 1962 * (0, astro_math_1.sin_deg)(Lp - F) + 318 * (0, astro_math_1.sin_deg)(A2);
        let sigmaB = 0;
        ...
        const rightAscensionDeg = (0, number_1.mod)((0, astro_math_1.atan2_deg)((0, astro_math_1.sin_deg)(longitudeDeg) * (0, astro_math_1.cos_deg)(obliquityDeg) - (0, astro_math_1.tan_deg)(latitudeDeg) * (0, astro_math_1.sin_deg)(obliquityDeg), (0, astro_math_1.cos_deg)(longitudeDeg)), 360);
        const declinationDeg = (0, astro_math_1.asin_deg)((0, astro_math_1.sin_deg)(latitudeDeg) * (0, astro_math_1.cos_deg)(obliquityDeg) +
            (0, astro_math_1.cos_deg)(latitudeDeg) * (0, astro_math_1.sin_deg)(obliquityDeg) * (0, astro_math_1.sin_deg)(longitudeDeg));
        const horizontalParallaxDeg = (0, astro_math_1.asin_deg)(astro_math_1.EARTH_EQUATORIAL_RADIUS_KM / distanceKm);
        return {
            longitudeDeg,
            latitudeDeg,
            distanceKm,
    ...
    lunarHorizontal(utc, latitudeDeg, longitudeDeg, heightM = 0) {
        ...
        const hourAngleDeg = (0, astro_math_1.signed_degree_diff)(siderealDeg, equatorial.rightAscensionDeg);
        const u = Math.atan(0.99664719 * Math.tan(latitudeDeg * astro_math_1.DEG_TO_RAD));
        const heightKm = heightM / 1000;
        const rhoSinPhiPrime = 0.99664719 * Math.sin(u) + (heightKm / astro_math_1.EARTH_EQUATORIAL_RADIUS_KM) * (0, astro_math_1.sin_deg)(latitudeDeg);
        const rhoCosPhiPrime = Math.cos(u) + (heightKm / astro_math_1.EARTH_EQUATORIAL_RADIUS_KM) * (0, astro_math_1.cos_deg)(latitudeDeg);
        ...
        const topocentricRightAscensionDeg = (0, number_1.mod)(equatorial.rightAscensionDeg + deltaAlphaRad * astro_math_1.RAD_TO_DEG, 360);
        const topocentricDeclinationDeg = (0, astro_math_1.atan2_deg)((Math.sin(declinationRad) - rhoSinPhiPrime * Math.sin(parallaxRad)) * Math.cos(deltaAlphaRad), Math.cos(declinationRad) - rhoCosPhiPrime * Math.sin(parallaxRad) * Math.cos(hourAngleRad));
        const horizontal = (0, astro_math_1.local_horizontal_from_equatorial)(utc, latitudeDeg, longitudeDeg, topocentricRightAscensionDeg, topocentricDeclinationDeg);
        return {
            ...equatorial,
            ...horizontal,
    ...
    lunarEvents(utc, options) {
        ...
        const dayStartUtc = options.dayStartUtc ?? Math.floor((utc + timezoneMsec) / astro_math_1.MSEC_PER_DAY) * astro_math_1.MSEC_PER_DAY - timezoneMsec;
    ...
    lunarApsis(kind, near) {
        ...
        for (let cursor = near - 14 * astro_math_1.MSEC_PER_DAY; cursor <= near + 14 * astro_math_1.MSEC_PER_DAY; cursor += step) {
    ...
    lunarNode(kind, near) {
        ...
        const eventAt = (0, astro_math_1.bisect_zero)(best.from, best.to, (at) => this.lunarEquatorial(at).latitudeDeg, 500, 48);
    ...
    timeOfLunarAltitude(from, to, altitudeDeg, latitudeDeg, longitudeDeg, heightM) {
        return (0, astro_math_1.bisect_zero)(from, to, (at) => this.lunarHorizontal(at, latitudeDeg, longitudeDeg, heightM).altitudeDeg - altitudeDeg);
    }
    timeOfLunarHourAngle(from, to, targetDeg, latitudeDeg, longitudeDeg, heightM) {
        return (0, astro_math_1.bisect_zero)(from, to, (at) => (0, astro_math_1.signed_degree_diff)(this.lunarHorizontal(at, latitudeDeg, longitudeDeg, heightM).hourAngleDeg, targetDeg));
    }
    phaseAt(utc) {
    ...
    phaseCorrection(phase, E, M, Mp, F, Omega) {
        ...
        const correction = -0.62801 * (0, astro_math_1.sin_deg)(Mp) +
    ...
    newOrFullCorrection(E, M, Mp, F, Omega, isFullMoon) {
        return ((isFullMoon ? -0.40614 : -0.4072) * (0, astro_math_1.sin_deg)(Mp) +
    ...
    additionalCorrection(k, T) {
        ...
        return angles.reduce((sum, angle, index) => sum + coefficients[index] * (0, astro_math_1.sin_deg)(angle), 0);
    }
}
