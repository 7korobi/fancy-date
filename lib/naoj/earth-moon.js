...
class EarthMoonOrbital {
    ...
    lunarEquatorial(utc) {
        ...
        const rightAscensionDeg = (0, number_1.mod)((0, astro_math_1.atan2_deg)((0, astro_math_1.sin_deg)(longitudeDeg) * (0, astro_math_1.cos_deg)(obliquityDeg) -
            (0, astro_math_1.tan_deg)(latitudeDeg) * (0, astro_math_1.sin_deg)(obliquityDeg), (0, astro_math_1.cos_deg)(longitudeDeg)), 360);
    ...
    lunarEvents(utc, options) {
        ...
        const dayStartUtc = options.dayStartUtc ??
            Math.floor((utc + timezoneMsec) / astro_math_1.MSEC_PER_DAY) * astro_math_1.MSEC_PER_DAY - timezoneMsec;
