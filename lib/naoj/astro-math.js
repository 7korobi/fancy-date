...
exports.EARTH_EQUATORIAL_RADIUS_KM = exports.MSEC_PER_MINUTE = exports.MSEC_PER_DAY = exports.RAD_TO_DEG = exports.DEG_TO_RAD = void 0;
...
Object.defineProperty(exports, "MSEC_PER_DAY", { enumerable: true, get: function () { return time_1.DAY; } });
Object.defineProperty(exports, "MSEC_PER_MINUTE", { enumerable: true, get: function () { return time_1.MINUTE; } });
...
function bisect_zero(from, to, valueAt, toleranceMsec = 500, maxIterations = 32) {
    ...
    for (let i = 0; i < maxIterations; i++) {
        ...
        if (Math.abs(end - start) < toleranceMsec)
...
function local_horizontal_from_equatorial(utc, latitudeDeg, longitudeDeg, rightAscensionDeg, declinationDeg) {
    ...
    const azimuthDeg = (0, number_1.mod)(atan2_deg(sin_deg(hourAngleDeg), cos_deg(hourAngleDeg) * sin_deg(latitudeDeg) - tan_deg(declinationDeg) * cos_deg(latitudeDeg)) + 180, 360);
