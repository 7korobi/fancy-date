...
class EarthSolarOrbital {
    ...
    static { this.meanSolarDayMsec = astro_math_1.MSEC_PER_DAY; }
    ...
    solarLongitudeDeg(utc) {
        ...
        return (0, number_1.mod)((earthLongitude / 1e8) * astro_math_1.RAD_TO_DEG + 180 - 0.00569 - 0.00478 * Math.sin(omega), 360);
    }
    solarEquatorial(utc) {
        const jde = (0, astro_math_1.julian_day)(utc) + (0, astro_math_1.delta_t_sec)(utc) / 86400;
        const longitudeDeg = this.solarLongitudeDeg(utc);
        const obliquityDeg = (0, astro_math_1.true_obliquity_deg)(jde);
        const rightAscensionDeg = (0, number_1.mod)((0, astro_math_1.atan2_deg)((0, astro_math_1.cos_deg)(obliquityDeg) * (0, astro_math_1.sin_deg)(longitudeDeg), (0, astro_math_1.cos_deg)(longitudeDeg)), 360);
        const declinationDeg = (0, astro_math_1.asin_deg)((0, astro_math_1.sin_deg)(obliquityDeg) * (0, astro_math_1.sin_deg)(longitudeDeg));
    ...
    solarHorizontal(utc, latitudeDeg, longitudeDeg) {
        ...
        const horizontal = (0, astro_math_1.local_horizontal_from_equatorial)(utc, latitudeDeg, longitudeDeg, equatorial.rightAscensionDeg, equatorial.declinationDeg);
    ...
    solarEvents(utc, options) {
        ...
        const midnightAt = this.timeOfSolarHourAngle(180, transitAt - astro_math_1.MSEC_PER_DAY / 2, latitudeDeg, longitudeDeg);
        ...
        const riseAt = Number.isNaN(hourAngleDeg)
            ? NaN
            : this.timeOfSolarAltitude(transitAt - (hourAngleDeg / SOLAR_HOUR_ANGLE_DEG_PER_DAY) * astro_math_1.MSEC_PER_DAY, latitudeDeg, longitudeDeg, horizonDeg);
    ...
    riseSetHourAngleDeg(latitudeDeg, declinationDeg, horizonDeg) {
        const value = ((0, astro_math_1.sin_deg)(horizonDeg) - (0, astro_math_1.sin_deg)(latitudeDeg) * (0, astro_math_1.sin_deg)(declinationDeg)) /
