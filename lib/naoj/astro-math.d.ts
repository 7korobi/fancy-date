...
export declare function bisect_zero(from: number, to: number, valueAt: (at: number) => number, toleranceMsec?: number, maxIterations?: number): number;
...
export declare function local_horizontal_from_equatorial(utc: number, latitudeDeg: number, longitudeDeg: number, rightAscensionDeg: number, declinationDeg: number): {
    altitudeDeg: number;
    azimuthDeg: number;
    hourAngleDeg: number;
};
