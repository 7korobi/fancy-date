...
exports.Tempo = exports.DAY = exports.MINUTE = void 0;
...
const DISTANCES = [
    ...
    [25000, 25000, 25000, '今'],
    [exports.MINUTE, SECOND, SECOND, '%s秒前'],
    [HOUR, exports.MINUTE, exports.MINUTE, '%s分前'],
    [exports.DAY, HOUR, HOUR, '%s時間前'],
...
class Tempo {
    ...
    slide(n) {
        if (this.table) {
            ...
            const idx = (0, number_1.mod)(now_idx, this.table.length);
...
function to_sec(str, { strict = false } = {}) {
    let timeout = 0;
    let consumed = '';
    str.replace(/(\d+)(([ヶヵかカケ箇]?月|[smhdwy秒分時日週年])[間]?(半$)?)|0/g, (full, num_str, fullunit, unit, appendix) => {
        consumed += full;
