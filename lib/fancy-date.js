...
class FancyDate {
  ...
  */
    ...
    to_tempos(utc) {
        ...
        const a = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year60, this.dic.a.length));
        const b = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year12, this.dic.b.length));
        const c = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year10, this.dic.c.length));
        const f = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year_s, this.dic.f.length));
