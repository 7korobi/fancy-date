...
exports.FancyDate = exports.MeanRotation = exports.TransformedOrbital = exports.MeanOrbital = exports.EarthSolarOrbital = exports.EarthMoonOrbital = void 0;
exports.transformOrbital = transformOrbital;
const tslib_1 = require("tslib");
const orbital_model_1 = require("./orbital-model");
const orbital_model_2 = require("./orbital-model");
...
class FancyDate {
    ...
    spot(...spot) {
        const [body, ...geo] = spot;
        const planet = (0, orbital_model_2.isPlanetSkyBody)(body) ? body : (0, orbital_model_2.centerOf)(body);
        const moony = (0, orbital_model_2.isPlanetSkyBody)(body) ? undefined : MeanOrbital.from((0, orbital_model_2.orbitalOf)(body));
        const sunny = (0, orbital_model_2.orbitalOf)(planet);
        const earthy = (0, orbital_model_2.rotationOf)(planet);
    ...
    assign_lunisolar_months(months) {
        let month = NaN;
    ...
    lunisolar_principal_term(monthStartAt, nextMonthStartAt) {
    ...
    local_day_start(utc) {
        return (0, time_1.to_tempo_bare)(this.calc.msec.day, this.calc.zero.day, utc).last_at;
    }
    local_timezone_msec() {
    ...
    solar_term(utc, phase) {
        ...
        return (0, time_1.to_tempo_bare)(this.calc.msec.day, this.calc.zero.day, at);
    }
  ...
  */
    noon(utc, day = (0, time_1.to_tempo_bare)(this.calc.msec.day, this.calc.zero.day, utc)) {
        ...
        const T0 = (0, time_1.to_tempo_bare)(this.calc.msec.year, this.calc.zero.season, utc);
        ...
        const T1 = (0, time_1.to_tempo_bare)(this.calc.msec.year, this.dic.sunny.epochMsec, 南中時刻);
    ...
    雑節_by_phase(utc) {
        let { 立春, 入梅, 春分, 半夏生, 夏土用, 立夏, 夏至, 秋土用, 立秋, 秋分, 冬土用, 立冬, 冬至, 春土用, 次立春: 立春2, } = this.solar_terms(utc);
        const [八十八夜, 二百十日, 二百二十日] = [88, 210, 220].map((n) => 立春.succ(n - 1));
        const [春彼岸, 秋彼岸] = [春分, 秋分].map((dd) => {
            return time_1.Tempo.join(dd.back(3), dd.succ(3));
        });
    ...
    to_tempos(utc) {
        ...
        if (this.is_table_leap) {
            ...
            V.now_idx = __mod__([11, 13, 15, 17, 19, 21, 24, 0, 2, 4, 7, 9][M.now_idx] + d.now_idx, this.dic.V.length);
        }
        return {
            Zz,
            A,
