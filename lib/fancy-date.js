...
// (確認済み)ため、この拡張は後方互換。
const reg_token = /([ABCEFHMNQVZabcdfmsy][or]|([ABCDEFGHJMNQSVYZabcdfmpsuwxy])\2*)|''|'(''|[^'])+('|$)|./g;
  ...
  */
    ...
    to_tempos(utc) {
        ...
        if (this.is_table_leap) {
            ...
            u = tempo_1.Tempo.at(new tempo_1.TableTempoRule(this.table.msec.year, this.calc.zero.period), {
                write_at: utc,
            });
            ...
            if (this.is_table_month) {
                u = tempo_1.Tempo.at(new tempo_1.FloorTempoRule(this.calc.msec.year, this.calc.zero.spring, [
                ...
                if (usesObservedLunisolar) {
                    ...
                    // 年境界でリセットされる。
                    u = tempo_1.Tempo.at(new tempo_1.EraAdjustedTempoRule(new tempo_1.ObservedLunisolarYearRule((at) => this.lunisolar(at)), this.calc.msec.year, this.table.msec.era, this.calc.zero.era, this.calc.eras), { write_at: utc });
                    M = tempo_1.Tempo.at(new tempo_1.ObservedLunisolarMonthRule((at) => this.lunisolar(at), moon_msec), {
                        write_at: utc,
                    });
                    ...
                    u = tempo_1.Tempo.at(new tempo_1.EraAdjustedTempoRule(new tempo_1.FloorTempoRule(this.calc.msec.year, this.calc.zero.season + this.calc.msec.season, [
        ...
        // 初期値定義と自己無矛盾になる。
        const a = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.raw_now_idx - this.calc.zero.year60, this.dic.a.length));
        const b = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.raw_now_idx - this.calc.zero.year12, this.dic.b.length));
        const c = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.raw_now_idx - this.calc.zero.year10, this.dic.c.length));
        const f = (0, tempo_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.raw_now_idx - this.calc.zero.year_s, this.dic.f.length));
        ...
        const A = tempo_1.Tempo.at(new tempo_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day60, this.dic.A.length), {
            write_at: utc,
        });
        const B = tempo_1.Tempo.at(new tempo_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day12, this.dic.B.length), {
            write_at: utc,
        });
        const C = tempo_1.Tempo.at(new tempo_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day10, this.dic.C.length), {
            write_at: utc,
        });
        const F = tempo_1.Tempo.at(new tempo_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day_9, this.dic.F.length), {
            write_at: utc,
        });
        let E;
        let V;
        if (this.is_table_leap) {
            // 旧暦では、週は月初にリセットする。
            E = tempo_1.Tempo.at(new tempo_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.week, this.dic.E.length), {
                write_at: utc,
            });
            V = tempo_1.Tempo.at(new tempo_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day28, this.dic.V.length), {
                write_at: utc,
            });
        }
        else {
            ...
            E = (0, tempo_1.cyclic_label)(dEnvelope, (0, number_1.mod)(M.now_idx + d.now_idx, this.dic.E.length));
            V = (0, tempo_1.cyclic_label)(dEnvelope, (0, number_1.mod)([11, 13, 15, 17, 19, 21, 24, 0, 2, 4, 7, 9][M.now_idx] + d.now_idx, this.dic.V.length));
        }
        return {
            Zz,
            A,
