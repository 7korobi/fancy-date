...
const tempo_model_1 = require("./tempo-model");
...
class FancyDate {
    ...
    def_zero() {
        ...
        this.dic.x.tempo = (0, tempo_model_1.cyclic_label)((0, tempo_model_1.envelope_of)(rawX), timezone);
  ...
  */
    ...
    雑節(utc, { Zz, d } = this.to_tempos(utc)) {
        return (0, solar_1.雑節_by_mean)(Zz, d, this.calc.msec.day, this.calc.zero.day10, this.dic.C.length);
    }
    雑節_by_phase(utc) {
    ...
    resolve_orbital_season(utc) {
        return tempo_model_1.TempoView.at(this.orbital_season_rule(), { write_at: utc });
    }
    /**
     ...
     */
    orbital_season_rule() {
        return (this._orbital_season_rule ??= new tempo_model_1.CachedTempoRule(new tempo_model_1.OrbitalPhaseTempoRule(this.dic.sunny, this.dic.Z.length, 1 / 8)));
    }
    /**
     ...
     */
    solar_hour_rule() {
        return (this._solar_hour_rule ??= new tempo_model_1.CachedTempoRule(new tempo_model_1.SolarDayHourTempoRule(this.dic.sunny, this.dic.earthy, this.dic.geo, this.calc.msec.day, this.calc.zero.day, this.calc.msec.year, this.calc.zero.season, this.dic.H.length)));
    }
    ...
    to_tempos(utc) {
        ...
        const J = tempo_model_1.TempoView.at(new tempo_model_1.FixedTempoRule(this.calc.msec.day, this.calc.zero.jd), {
            write_at: utc,
        }); // ユリウス日
        // season in year_of_planet
        const Zz = tempo_model_1.TempoView.at(new tempo_model_1.FixedTempoRule(this.calc.msec.year, this.calc.zero.season), {
            write_at: utc,
        }); // 太陽年
        ...
        const seasonRule = new tempo_model_1.SubdivideTempoRule(this.calc.msec.season);
        const ZzEnvelope = (0, tempo_model_1.envelope_of)(Zz);
        const resolve_season = (at) => usesOrbitalSeasons
            ? this.resolve_orbital_season(at)
            : tempo_model_1.TempoView.at(seasonRule, { write_at: at, parent: ZzEnvelope });
        ...
        if (this.dic.moony && moon_msec != null && !usesObservedLunisolar) {
            ...
            // される不具合があった)。
            Nn = tempo_model_1.TempoView.at(new tempo_model_1.MeanLunisolarMonthRule(moon_msec, this.calc.zero.moon, this.calc.msec.day, this.calc.zero.day, this.dic.Z.length, resolve_season), { write_at: utc });
            N = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.day), {
                write_at: utc,
                parent: (0, tempo_model_1.envelope_of)(Nn),
            });
        }
        if (this.is_table_leap) {
            p = tempo_model_1.TempoView.at(new tempo_model_1.FixedTempoRule(this.calc.msec.period, this.calc.zero.period), {
                write_at: utc,
            });
            ...
            u = tempo_model_1.TempoView.at(new tempo_model_1.TableTempoRule(this.table.msec.year, this.calc.zero.period), {
                write_at: utc,
            });
            M = tempo_model_1.TempoView.at(new tempo_model_1.TableTempoRule(this.table.msec.month[u.size], u.last_at), {
                write_at: utc,
            });
            d = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.day), {
                write_at: utc,
                parent: (0, tempo_model_1.envelope_of)(M),
            });
        }
        else {
            if (this.is_table_month) {
                u = tempo_model_1.TempoView.at(new tempo_model_1.FloorTempoRule(this.calc.msec.year, this.calc.zero.spring, [
                ...
                if (usesObservedLunisolar) {
                    ...
                    // 年境界でリセットされる。
                    u = tempo_model_1.TempoView.at(new tempo_model_1.EraAdjustedTempoRule(new tempo_model_1.ObservedLunisolarYearRule((at) => this.lunisolar(at)), this.calc.msec.year, this.table.msec.era, this.calc.zero.era, this.calc.eras), { write_at: utc });
                    M = tempo_model_1.TempoView.at(new tempo_model_1.ObservedLunisolarMonthRule((at) => this.lunisolar(at), moon_msec), {
                        write_at: utc,
                    });
                    ...
                    u = tempo_model_1.TempoView.at(new tempo_model_1.EraAdjustedTempoRule(new tempo_model_1.FloorTempoRule(this.calc.msec.year, this.calc.zero.season + this.calc.msec.season, [
        ...
        if (this.dic.is_solor) {
            H = tempo_model_1.TempoView.at(this.solar_hour_rule(), { write_at: utc, day: (0, tempo_model_1.envelope_of)(d) });
            m = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(H.size / this.dic.m.length), {
                write_at: utc,
                parent: (0, tempo_model_1.envelope_of)(H),
            });
        }
        else {
            H = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.hour), {
                write_at: utc,
                parent: (0, tempo_model_1.envelope_of)(d),
            });
            m = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.minute), {
                write_at: utc,
                parent: (0, tempo_model_1.envelope_of)(H),
            });
        }
        const s = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.second), {
            write_at: utc,
            parent: (0, tempo_model_1.envelope_of)(m),
        });
        const S = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.msec), {
            write_at: utc,
            parent: (0, tempo_model_1.envelope_of)(s),
        });
        ...
        // `{}` キャストで型を偽ることは避ける)。
        let G = (0, tempo_model_1.cyclic_label)((0, tempo_model_1.envelope_of)(u), 0);
        if (this.table.msec.era != null) {
            G = tempo_model_1.TempoView.at(new tempo_model_1.TableTempoRule(this.table.msec.era, this.calc.zero.era), {
                write_at: utc,
            });
        ...
        const uEnvelope = (0, tempo_model_1.envelope_of)(u);
        // 年初来番号
        const w0 = tempo_model_1.TempoView.at(new tempo_model_1.FixedTempoRule(this.calc.msec.week, this.calc.zero.week), {
            write_at: u.last_at,
        });
        const w = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.week), {
            write_at: utc,
            parent: (0, tempo_model_1.envelope_of)(w0),
        });
        const D = tempo_model_1.TempoView.at(new tempo_model_1.SubdivideTempoRule(this.calc.msec.day), {
            write_at: utc,
            parent: uEnvelope,
        });
        // 年末最終週は、翌年初週の扱いにする。Y はその調整を反映した年ラベル。
        const yearEndsInNextYearsFirstWeek = u.next_at < w.next_at;
        const Y = (0, tempo_model_1.cyclic_label)(uEnvelope, u.now_idx + (yearEndsInNextYearsFirstWeek ? 1 : 0));
        if (yearEndsInNextYearsFirstWeek) {
            w.now_idx = 0;
        }
        // 年不断(u の実区間はそのままに、干支等の周期ラベルだけ差し替える)
        const a = (0, tempo_model_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year60, this.dic.a.length));
        const b = (0, tempo_model_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year12, this.dic.b.length));
        const c = (0, tempo_model_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year10, this.dic.c.length));
        const f = (0, tempo_model_1.cyclic_label)(uEnvelope, (0, number_1.mod)(u.now_idx - this.calc.zero.year_s, this.dic.f.length));
        // 月不断(四半期は月をまたぐため、区間は M(現在の月)のものをそのまま使う。
        // 四半期全体の境界ではない点に注意)
        const Q = (0, tempo_model_1.cyclic_label)((0, tempo_model_1.envelope_of)(M), Math.floor((4 * M.now_idx) / this.dic.M.length));
        // 日不断(固定 zero からの周期を length で割った余りをラベルにする)
        const A = tempo_model_1.TempoView.at(new tempo_model_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day60, this.dic.A.length), {
            write_at: utc,
        });
        const B = tempo_model_1.TempoView.at(new tempo_model_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day12, this.dic.B.length), {
            write_at: utc,
        });
        const C = tempo_model_1.TempoView.at(new tempo_model_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day10, this.dic.C.length), {
            write_at: utc,
        });
        const F = tempo_model_1.TempoView.at(new tempo_model_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day_9, this.dic.F.length), {
            write_at: utc,
        });
        let E;
        let V;
        if (this.is_table_leap) {
            // 旧暦では、週は月初にリセットする。
            E = tempo_model_1.TempoView.at(new tempo_model_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.week, this.dic.E.length), {
                write_at: utc,
            });
            V = tempo_model_1.TempoView.at(new tempo_model_1.CyclicDayTempoRule(this.calc.msec.day, this.calc.zero.day28, this.dic.V.length), {
                write_at: utc,
            });
        }
        else {
            ...
            const dEnvelope = (0, tempo_model_1.envelope_of)(d);
            E = (0, tempo_model_1.cyclic_label)(dEnvelope, (0, number_1.mod)(M.now_idx + d.now_idx, this.dic.E.length));
            V = (0, tempo_model_1.cyclic_label)(dEnvelope, (0, number_1.mod)([11, 13, 15, 17, 19, 21, 24, 0, 2, 4, 7, 9][M.now_idx] + d.now_idx, this.dic.V.length));
        }
        return {
            Zz,
            A,
